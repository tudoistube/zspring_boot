 ...
 */
@Controller
@RequestMapping("/") //...ReadingListController가 처리하도록 하기 위해 주석처리함.
/*
 * ...104p.프로퍼티 주입.
...
public class ReadingListController {
  ...
  //public ReadingListController(ReadingListJpaRepository readingListJpaRepository) {//...by107p.
  	public ReadingListController(ReadingListRepository readingListJpaRepository,
  								 AmazonProperties amazonProperties) {
  		this.readingListRepository = readingListJpaRepository;
	...
	public String readersBooks(Reader reader, Model model){
        ...
        if (readingList != null) {
          ...
          //...104p.application.yml 에서 amazon.associateId 속성값을 readingList.html 에 전달함.
            model.addAttribute("associateId", amazonProperties.getAssociateId()); //...107p.modified.
        }
        return "readingList";
    }
