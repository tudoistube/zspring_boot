 ...
 *    읽어서 처리함.
 */
//@ConfigurationProperties(prefix="amazon") //...104p.
public class ReadingListController_by106p {
	 ...
	 */
	@Autowired
	public ReadingListController_by106p(ReadingListJpaRepository readingListJpaRepository) {
